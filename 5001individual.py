...
train_data = pd.read_csv('/Users/levichen/Desktop/1ttrr.csv').astype(str)
y = pd.read_csv('/Users/levichen/Desktop/trainlog.csv').astype(str)
test_data = pd.read_csv('/Users/levichen/Desktop/1tt.csv').astype(str)
...
y = pd.read_csv('/Users/levichen/Desktop/trainl2.csv').astype('str')
...
R = model.predict(Z)
print(R)
pd.DataFrame(R, columns=['time']).to_csv('/Users/levichen/Desktop/sub1.csv',header='time',index_label='id')
...
# X = pd.read_csv('/Users/levichen/Desktop/2ttrr.csv')
# y = pd.read_csv('/Users/levichen/Desktop/trainlog.csv')
# X_train, X_validation, y_train, y_validation = train_test_split(X, y, train_size=0.8)
...
# print(R)
# pd.DataFrame(R).to_csv('/Users/levichen/Desktop/15.csv')


#then time = 2^R
#choose the best performance result and final result is as following:
#result of method1 * 0.4 + result of method2 * 0.6